                                ...
                                <div className="mb-12 space-y-6 text-center">
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-muted-foreground text-lg">
                                            ...
                                            for students of <br /> Bachelor of
                                ...
                                <div className="mb-12 space-y-8">
                                    <div className="space-y-4 text-center">
                                        ...
                                        <p className="text-muted-foreground">
                                            Simple steps to find your perfect
                                            internship match
                                        </p>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                                        ...
                                        <Card className="border-[#e3e3e0] bg-white dark:border-[#3E3E3A] dark:bg-[#161615]">
                                            ...
                                            <CardContent>
                                                <CardDescription className="text-[#706f6c] dark:text-[#A1A09A]">
                                                    Our deterministic weighted
                                                    scoring algorithm analyzes
                                                    skills to match students
                                                    with suitable HTEs.
                                                </CardDescription>
                                            </CardContent>
                                        </Card>
                                        ...
                                        <Card className="border-[#e3e3e0] bg-white dark:border-[#3E3E3A] dark:bg-[#161615]">
                                            ...
                                            <CardContent>
                                                <CardDescription className="text-[#706f6c] dark:text-[#A1A09A]">
                                                    The SIP Coordinator endorses
                                                    students for HTE's to review
                                                    and place.
                                                </CardDescription>
                                            </CardContent>
                                        </Card>
                                        ...
                                        <Card className="border-[#e3e3e0] bg-white dark:border-[#3E3E3A] dark:bg-[#161615]">
                                            ...
                                            <CardContent>
                                                <CardDescription className="text-[#706f6c] dark:text-[#A1A09A]">
                                                    ...
                                                    their matched HTEs to begin
                                                    their internship journey and
                                                    gain experience.
                                                </CardDescription>
                                            </CardContent>
                                        </Card>
